...
- "mco rpc r10k deploy environment=production" not working on Debian 8.3 [\#271](https://github.com/voxpupuli/puppet-r10k/issues/271)
- discussion: r10k deploy environment with no -p argument [\#265](https://github.com/voxpupuli/puppet-r10k/issues/265)
- r10k does not install via Puppet on Puppet 4 [\#258](https://github.com/voxpupuli/puppet-r10k/issues/258)
...
- Fix a few typos. [\#167](https://github.com/voxpupuli/puppet-r10k/pull/167) ([fnaard](https://github.com/fnaard))
