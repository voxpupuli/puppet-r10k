...
class r10k::params {
  ...
  $webhook_chatops_service = undef
  $webhook_chatops_channel = undef
  $webhook_chatops_user = undef
  $webhook_chatops_token = undef
  $webhook_chatops_uri = undef
  ...
  $webhook_r10k_branch_prefix = undef
